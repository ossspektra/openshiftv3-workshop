...
image::https://github.com/ossspektra/openshiftv3-workshop/raw/master/images/scale_updown_overview.png[image]
...
image::https://github.com/ossspektra/openshiftv3-workshop/raw/master/images/scale_updown_overview_scaled.png[image]

*Note:* You can also scale up and down from the web console by going to
the project overview page and clicking twice on
image::https://github.com/ossspektra/openshiftv3-workshop/raw/master/images/scale_up.jpg[image] right next to the pod count circle to
add 2 more pods.
...
image::https://github.com/ossspektra/openshiftv3-workshop/raw/master/images/idled_pods.jpeg[image]
