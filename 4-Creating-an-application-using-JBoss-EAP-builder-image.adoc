...
image::https://github.com/ossspektra/openshiftv3-workshop/raw/master/images/jboss_wizard_configuration.png[image]
image::https://github.com/ossspektra/openshiftv3-workshop/raw/master/images/jboss_wizard_configuration2.png[image]
