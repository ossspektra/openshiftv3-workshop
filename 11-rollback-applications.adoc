...
image::https://raw.githubusercontent.com/ossspektra/openshiftv3-workshop/3.6/images/blue_app.jpg[image]
...
image::https://raw.githubusercontent.com/ossspektra/openshiftv3-workshop/3.6/images/green_app.jpg[image]
